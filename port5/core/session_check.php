<?php
session_start();
if(!isset($_SESSION['konnect_admin']))
{
?>
<!DOCTYPE html>
...
<body class="" style="dbackground-image: url('back5.jpg'); background-color: white;">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
       <section class="m-b-lg" style="margin-top: 30px;">
        ...
        <div style="text-align: center;"><a dclass="navbar-brand block" href="#" style="color: white; font-size: 25px; "><img src="icon/logo2.png" width="200" height="50px"></a>
     </div>
