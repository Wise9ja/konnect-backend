  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <div class="col-md-4" style="text-align: left; margin-top: 10px;">  <a href="?p=new_state"> <button class="btn btn-primary" style="font-size: 16px; font-weight: 600;">Add New State</button></a>  </div>
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $state; ?><td style="border:solid; border-width: thin; border-color: #eee;"><button class="btn btn-danger" onclick="delete_state('<?php echo $id; ?>');">Delete</button></td></td></td></td></tr>
