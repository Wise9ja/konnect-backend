  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <div class="row">
      ...
      <p><a href="#"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a class="active">Customers</a></p>
    </div>
...
<div style="margin: 20px; margin-top: 0px;">
        ...
        <input type="text" name="q" value="<?php echo $_GET['q']; ?>" placeholder="Search By First Name or Last Name" style="height: 30px; font-size: 15px; padding: 15px; width: 80%; border:solid; border-color: #cccccc;"> 
       </form>
     </div>
...
<table class="table dtable-striped table-hover no-head-border" border="1" style="border:solid; border-color: black; border-width: thin;">
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">First Name</th>
...
$sql=$con->query("SELECT * FROM customers ORDER BY id DESC LIMIT 0,200") or die("Error2 : ". mysqli_error($con));

if(isset($_GET['q']))
{
$q = $_GET['q'];
$sql=$con->query("SELECT * FROM customers WHERE fname LIKE '%$q%' OR lname LIKE '%$q%'  ORDER BY id DESC LIMIT 0, 200") or die("Error2 : ". mysqli_error($con));
}
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $fname; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $lname; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $email; ?> <td><?php echo $phone; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $date_t; ?></td></td></td></td></tr>
