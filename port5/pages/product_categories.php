  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <div class="row">
      ...
      <p><a href="#"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a class="active">Product Category</a></p>
    </div>
...
<table class="table dtable-striped table-hover no-head-border" border="1">
 ...
 <th style="border:solid; border-width: thin; border-color: #eee;">Product Sector</th>
 <th style="border:solid; border-width: thin; border-color: #eee;">Product Category</th>
...
$sql=$con->query("SELECT * FROM product_category ORDER BY id DESC") or die("Error2 : ". mysqli_error($con));
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $sector; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $category; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $date_t; ?> <!--<td><a href="update_biz_unit.php?id=<?php echo $id; ?>"><button>Edit</button>--><td style="border:solid; border-width: thin; border-color: #eee;"><button class="btn btn-danger" onclick="delete_cat('<?php echo $id; ?>');">Delete</button></td></td></td></td></tr>
