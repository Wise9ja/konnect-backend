...
'.$category.'
  ...
  if($product_cat !== "HOT OFFERS")
  {
    $query=  "SELECT * FROM product WHERE product_type = 'Tangible' AND product_category = '$product_cat' AND status != 'Hidden' ORDER BY id DESC LIMIT 0,16";
  }
  ...
  {
       $query=  "SELECT * FROM product WHERE product_type = 'Tangible' AND status != 'Hidden' ORDER BY id DESC LIMIT 0,16";
...
global $connn ;
    ...
    if($product_cat !== "HOT OFFERS")
    {
        $query=  "SELECT * FROM product WHERE product_type = 'Tangible' AND product_category = '$product_cat' AND status != 'Hidden' ORDER BY id DESC LIMIT 16,32";
    }else
    {
        $query=  "SELECT * FROM product WHERE product_type = 'Tangible' AND status != 'Hidden' ORDER BY id DESC LIMIT 16,32";
