...
$sqlw = $con->query("SELECT * FROM sales WHERE user = '$user' AND  order_status ='Cancelled' AND payment_status = 'Successful' ") or die("Error2 : " . mysqli_error($con));
...
$total = number_format($order['total'],2);
                    ...
                    $orders .= '<div class="cart_card row">
                        ...
                        <div class="col-sm-9"><br>
                            ...
                            <div class="row" style="margin-top:30px">
                                <div class="col-sm-8">
                                    <h5 style="" class="text-danger">Cancelled</h5>
                                </div>
                                <div class="col-sm-4">
                 ...
                 if($countw==0)
                    {
                $orders = '<div>You have no canceled order!</div>';
                 }
